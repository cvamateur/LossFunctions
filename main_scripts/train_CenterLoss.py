...
def main(args):
    ...
    center_loss_fn = CenterLoss(2, 10).to(device)
    ...
    optimizer = Adam([{"params": extractor.parameters()},
                      ...
                      {"params": center_loss_fn.parameters(), "weight_decay": 0}],
    ...
    for epoch in range(1, args.num_epochs + 1):
        ...
        visualizer.save_fig(epoch, dpi=args.dpi, loss_weight=args.loss_weight)
        schedular.step()
...
def train_step(epoch, model, dataset, criterion, optimizer, visualizer, args):
    ...
    for i, (images, labels) in enumerate(dataset):
        ...
        center_loss = criterion[1](feats, labels) * args.loss_weight
