"""
Train MNIST with L-Softmax Loss

Structure:
    extractor -> L-SoftmaxLinear -> SoftmaxLoss
"""
import torch
...
def main(args):
    ...
    # Visualizer
    ################
    visualizer = FeatureVisualizer("L-SoftmaxLoss", len(ds_train), len(ds_valid), args.batch_size,
